...
def move(x1,y1,x2,y2):
     ...
     win32api.mouse_event(win32con.MOUSEEVENTF_LEFTDOWN,x1,y1,100,100)
     sleep(1)
     win32api.SetCursorPos((x2,y2))
     win32api.mouse_event(win32con.MOUSEEVENTF_LEFTDOWN,x2,y2,100,100)

 
def rightdown(x,y):
     win32api.SetCursorPos((x,y))
     win32api.mouse_event(win32con.MOUSEEVENTF_RIGHTDOWN,x,y,100,100)
     
def rightup(x,y):
     win32api.SetCursorPos((x,y))
     win32api.mouse_event(win32con.MOUSEEVENTF_RIGHTUP,x,y,100,100)
